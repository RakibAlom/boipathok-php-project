    ...
    <section class="mag-posts-area d-flex flex-wrap">
        ...
        <div class="post-sidebar-area left-sidebar mt-3 mb-30 bg-white box-shadow">
            ...
            <div class="single-sidebar-widget p-30">
                ...
                <div class="single-blog-post d-flex">
                    ...
                    <div class="post-content">
                        <h1><a href="single_post.php?post_id=<?php echo $result['post_id']; ?>" class="post-title"><?php echo $result['post_name']; ?></a></h1>
                        <span><?php echo substr($result['post_text'],0,150); ?></span>
            ...
            <div class="single-sidebar-widget p-15">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-content">
                        <a href="single_post.php?post_id=<?php echo $result['post_id']; ?>" class="post-title"><?php echo $result['post_name']; ?></a>
        ...
        <div class="mag-posts-content mt-3 mb-30 p-30 box-shadow">
                        ...
                        ?>
                            <div class="single-featured-post">
                                ...
                                <div class="post-content">
                                    ...
                                    <p><?php echo substr($result['post_text'],0,450); ?> <a class="text-primary" href="single_post.php?post_id=<?php echo $result['post_id']; ?>">Read more...</a></p>
            ...
            <div class="most-viewed-videos mb-30">
                ...
                <?php 
                 ...
                 ?>
                    <!-- Single Blog Post -->
                    <div class="single-blog-post-2 style-4">
                        <a href="single_post.php?post_id=<?php echo $result['post_id']; ?>" class="post-title">
                            <div class="post-thumbnail">
                                <img src="adminpanel/img/post/<?php echo $result['post_image']; ?>" alt="">
                            </div>
                            <div class="post-content">
                                <h1><a href="single_post.php?post_id=<?php echo $result['post_id']; ?>" class="post-title text-info"><?php echo $result['post_name']; ?></a></h1>
            ...
            <div class="single-sidebar-widget p-30">
                ...
                <div class="single-youtube-channel d-flex">
                    ...
                    <div class="youtube-channel-content">
                        <a href="" class="channel-title"><?php echo $result['user_name']; ?></a>
