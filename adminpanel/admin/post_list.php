<?php 
	...
	$sql = "SELECT categories.cate_name, categories_level.cate_level_name, post.* FROM post INNER JOIN categories ON categories.cate_id = post.cate_id INNER JOIN categories_level ON categories_level.cate_level_id = post.cate_level_id ORDER BY post_id desc";
                          ...
                          <?php 
                            if ($result['post_status'] == 1) {
                              ...
                              <form action="" method="post">
                                  ...
                                  <a class="btn btn-info btn-sm" href="post_view.php?post_id=<?php echo $result['post_id']; ?>">View</a>
  ...
  if (isset($_POST['delete'])) {
        ...
        if ($run) {
          ?>
            <script>
              alert('Deleted Post');
              window.open('post_list.php','_self');
            </script>
          <?php
        }else{
          ?>
