  ...
  <div id="wrapper">
        ...
        <div class="container-fluid">
            <div class="header-section">
              <span class="header-section-name"><?php  echo $result['admin_name']; ?>'s Profile</span>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><?php echo $result['admin_name']; ?>'s Post List</h6>
            </div>
            <div class="card-body">
