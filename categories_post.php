<?php 
    ...
    include ('dbcon.php'); 
    $id = $_GET['categories'];
    $sql = "SELECT categories.cate_name,post.* FROM post INNER JOIN categories ON categories.cate_id = post.cate_id WHERE post.cate_id = '$id' AND post_status = '1'";
    ...
    $sql2 = "SELECT categories.cate_name,categories_level.cate_level_name, post.* FROM post INNER JOIN categories ON categories.cate_id = post.cate_id INNER JOIN categories_level ON categories_level.cate_level_id = post.cate_level_id WHERE post.cate_id = '$id' ORDER BY post_id desc LIMIT $this_page_first_result,$result_per_page";
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo $result2['cate_name'];  ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="pagination-system mt-2" align="center">
                    <?php 
                        if ($page == 1) {
                            ...
                            ?><a href="categories_post.php?page=<?php echo $previous_page; ?>"><i class="fa fa-long-arrow-left"></i>  Previous page</a> &nbsp; &nbsp; &nbsp;
                            <?php
                        }
                     ?>
                    <?php 
                        if ($page == $number_of_page) {
                            ...
                            $next_page = $page + 1;
                            ?>
                            <span class="next-page"><a href="categories_post.php?page=<?php echo $next_page; ?>">Next Page <i class="fa fa-long-arrow-right"></i></a></span>
                            <?php
                        }
                     ?>
                </div>
